  ...
  return (
    <div className="w-full text-white bg-gradient-to-b from-[#000000] to-[#0B6E4F]">
      <div className="py-16 px-4 text-center">
        ...
        <h1 className="font-normal mb-3 fade-up">The Agentic AI Hiring Partner</h1>
        <p className="fade-up">
      ...
      <div className="flex justify-center max-w-[1600px] mx-auto">
        <div className="w-full rounded-xl overflow-hidden fade-up">
          <ImageSlider />
        </div>
      </div>
      <div className="py-16 px-4 text-center">
        <div className="mx-auto">
          <p className="mb-8 max-w-2xl mx-auto fade-up">
          ...
          <button className="fade-up bg-white text-black px-8 py-3 rounded-lg font-bold hover:bg-gray-200 transition-colors mb-12">
            BOOK A DEMO
          </button>
          ...
          <div className="mx-auto">
            <h2 className="font-normal mb-6 fade-up">Built for Recruiters Who Think Ahead</h2>

            <div className="mb-6 flex flex-col md:flex-row flex-col-reverse items-center justify-center gap-4">
              <p className="tooltip font-normal text-white fade-up">
                Forget filters and forms.
              </p>
              <p className="text-white max-w-lg text-start fade-up">
