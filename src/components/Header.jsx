...
export default function Navbar() {
  return (
    <Disclosure
      as="nav"
      className="bg-white/90 backdrop-blur-md pt-4 z-50 sticky top-0"
    >
      {({ open }) => (
        <>
          <div className="mx-auto container px-4 sm:px-6 !py-0">
            ...
            <div className="flex items-center h-20 justify-between">
                        ...
                        <div>
                          <MenuButton
                            className={classNames(
                              ...
                              "inline-flex items-center px-3 py-2 text-md font-medium rounded-md focus:outline-none"
                            )}
                          >
                            <span>{item.name}</span>
                            <ChevronDownIcon
              ...
              <div className="flex items-center space-x-3">
                ...
                <button
                  type="button"
                  className=" items-center bg-[#8CB183] text-white font-medium text-sm md:text-lg rounded-md px-4 py-2 cursor-pointer border-3 border-transparent hover:bg-transparent hover:text-[#8CB183] hover:border-[#8CB183] transition-all duration-200"
                >
                  GET A DEMO
                </button>
