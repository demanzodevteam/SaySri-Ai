...
export default function BookDemo() {
    return (
        <div className="container mx-auto">
            <div className="py-20 px-10 md:p-50 bg-black rounded-3xl  bg-center bg-no-repeat bg-contain md:bg-[length:600px_auto]" style={{ backgroundImage: `url(${HeroImg.src})` }}>
