            ...
            <div className="mx-auto container text-center">
                ...
                <div className="mb-12">
                    <div className="relative w-full ">
                        ...
                        <span className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-white flex items-center text-start gap-6 px-12 w-4xl">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-10 max-w-5xl mx-auto mt-26">
