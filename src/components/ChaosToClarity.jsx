    ...
    return (
        <div className="bg-black w-full text-white">
            <div className="mx-auto container text-center space-y-6">
                <div>
                    <div>
                        <h1 className="mb-4">From Chaos to Clarity</h1>
                        <p className="mb-16 max-w-lg mx-auto">
                    ...
                    <div className="mb-12">
                        <div className="relative w-full ">
                            ...
                            <span className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 bg-black text-white flex flex-col md:flex-row items-center text-center gap-2 md:gap-6 px-12 w-sm md:w-4xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-10 max-w-5xl mx-auto mt-26">
                        {features.map((feature, index) => (
                            <div
                                key={index}
                                className="bg-black p-10 rounded-2xl border border-[#08A045] text-center flex flex-col items-center gap-4 shadow-[0px_7px_20px_0px_#03AC13]"
                            >
